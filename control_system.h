...
//	if (get_entity_components(ID).m_name == "ship") {
//
//		if (IsMouseButtonDown(MOUSE_BUTTON_LEFT)) {
//			update_entity_components(
//				ID,
//				get_entity_components(ID).m_name,
//				get_entity_components(ID).m_mass,
//				get_entity_components(ID).m_color,
//				get_entity_components(ID).m_position, get_entity_components(ID).m_velocity, get_entity_components(ID).m_acceleration, get_entity_components(ID).m_force,
//				0, 0, 0, 0,
//				get_entity_components(ID).m_shape,
//				get_entity_components(ID).m_target_id, get_entity_components(ID).m_is_targeted, get_entity_components(ID).m_has_gravity
//			);
//		};
//	};
//};

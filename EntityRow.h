...
public:
	...
	Color m_color;  // color, uses raylib's color struct
	...
	bool m_uses_prop_nav; // whether or not this entity uses proportional navigation to track targets
	...
	std::vector<float> m_buffer1; // buffer array for storing angles to calculate change in LOS angle for prop nav

...
public:
	...
	void set_values() const {
		...
		ship.set_components(
			...
			// MISC
			m_shape, // vector of Vector2 objects describing entity vertices
			m_target_id, // missiles and lasers target objects, planetoids do not
			m_is_targeted // anything can be targeted
		);
	};
};
